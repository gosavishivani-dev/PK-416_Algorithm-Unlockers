...
public class Predict_Price extends AppCompatActivity {

    private static final String[] item = new String[]{"Onion","Tomato","Cotton","Jowar","Rice","Tur","Coffee","Garlic","Lemon","Sugarcane"};
    private static final String[] item_1 = new String[]{"Bengaluru","Kolar","Mysur"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crop__price);
        ...
        AutoCompleteTextView act2 = (AutoCompleteTextView)findViewById(R.id.dropdown_text_1) ;
        textlayOut = findViewById(R.id.text_input_layout_1);
        ...
        ArrayAdapter<String> adapter_1 = new ArrayAdapter<String>(this,android.R.layout.simple_dropdown_item_1line,item_1);
    ...
    private void callPreFunc()
    {
        ...
        final String URL = "http://192.168.43.131:8026/pricePredict";
        // Post params to be sent to the server
        HashMap<String, String> params = new HashMap<String, String>();
        final String str = textlayOut.getEditText().getText().toString();
        params.put("commodity", str);
        final String str_1 = textlayOut_1.getEditText().getText().toString();
        params.put("market", str_1);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < prediction.length(); i++) {
                                ...
                                String arrival = c.getString("Modal");
                                double value = Double.parseDouble(arrival);
                                String strVal =  String.format("%.2f", value);


                                webString = webString + "<tr><td>" + commodity + "</td><td>" + date + "<tr><td>" + Market + "</td><td>"+ arrival + "</td><td>";
