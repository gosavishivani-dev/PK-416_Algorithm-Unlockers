...
public class Predict_Psf extends AppCompatActivity {
    ...
    private WebView webView;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_crop__psf);
    ...
    private void callPreFunc()
    {
        ...
        final String URL = "http://192.168.43.131:8026/psfPredict";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            String webString = "<html>\n" +
                                    ...
                                    "  <tr>\n" +
                                    "    <th>Min (Unit Rupees)</th> \n" +
                                    "    <th>Max (Unit Rupees)</th> \n" +
                                    "    <th>PSF (Unit Rupees)</th> \n" +
                                    "  </tr>\n";
                            ...
                            for (int i = 0; i < prediction.length(); i++) {
                                ...
                                String psf = c.getString("PSF");
                                double value = Double.parseDouble(min);
                                String strMin =  String.format("%.2f", value);

                                value = Double.parseDouble(max);
                                String strMax =  String.format("%.2f", value);

                                value = Double.parseDouble(psf);
                                String strPSF =  String.format("%.2f", value);

                                webString = webString + "<tr><td>" + strMin + "</td>" + "<td>" + strMax + "</td>" + "<td>" + strPSF + "</td></tr>";
